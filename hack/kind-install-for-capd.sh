...
# The modifications below are designed to incorporate some custom CLU arguments and mount the docker socket inside
# the KIND cluster so that CAPD can be used to created docker containers.
