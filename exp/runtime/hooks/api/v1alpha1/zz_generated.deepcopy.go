...
func (in *DiscoveryResponse) DeepCopyInto(out *DiscoveryResponse) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ResponseMeta = in.ResponseMeta
	if in.Handlers != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResponseMeta) DeepCopyInto(out *ResponseMeta) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResponseMeta.
func (in *ResponseMeta) DeepCopy() *ResponseMeta {
	if in == nil {
		return nil
	}
