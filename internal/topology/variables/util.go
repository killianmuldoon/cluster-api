...
// convertToUpstreamJSONSchemaProps converts a clusterv1.JSONSchemaProps to
// apiextensions.JSONSchemaProp.
// NOTE: This func is used whenever we want to use one of the upstream libraries, because
// they are using apiextensions.JSONSchemaProp.
...
func convertToUpstreamJSONSchemaProps(schema *clusterv1.JSONSchemaProps, _ *field.Path) (*apiextensions.JSONSchemaProps, error) {
