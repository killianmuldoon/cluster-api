...
func TestReconcileCluster(t *testing.T) {
	cluster1 := builder.NewClusterBuilder(metav1.NamespaceDefault, "cluster1").
		Build()
	cluster1WithReferences := builder.NewClusterBuilder(metav1.NamespaceDefault, "cluster1").
		WithInfrastructureCluster(builder.NewInfrastructureClusterBuilder(metav1.NamespaceDefault, "infrastructure-cluster1").
			Build()).
		WithControlPlane(builder.NewControlPlaneBuilder(metav1.NamespaceDefault, "control-plane1").Build()).
		Build()
...
func TestReconcileInfrastructureCluster(t *testing.T) {
	...
	clusterInfrastructure1 := builder.NewInfrastructureClusterBuilder(metav1.NamespaceDefault, "infrastructure-cluster1").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
	clusterInfrastructure2 := builder.NewInfrastructureClusterBuilder(metav1.NamespaceDefault, "infrastructure-cluster2").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
	clusterInfrastructure3 := builder.NewInfrastructureClusterBuilder(metav1.NamespaceDefault, "infrastructure-cluster3").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
	...
	clusterInfrastructure4 := builder.NewInfrastructureClusterBuilder(metav1.NamespaceDefault, "infrastructure-cluster4").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
	...
	g.Expect(err).ToNot(HaveOccurred())
	clusterInfrastructure5 := builder.NewInfrastructureClusterBuilder(metav1.NamespaceDefault, "infrastructure-cluster5").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
...
func TestReconcileControlPlaneObject(t *testing.T) {
	...
	infrastructureMachineTemplate := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infra1").Build()
	infrastructureMachineTemplate2 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infra2").Build()
	...
	controlPlane1 := builder.NewControlPlaneBuilder(metav1.NamespaceDefault, "cp1").
		WithInfrastructureMachineTemplate(infrastructureMachineTemplate).
		Build()
	controlPlane2 := builder.NewControlPlaneBuilder(metav1.NamespaceDefault, "cp2").
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			fakeObjs := make([]client.Object, 0)
			s := scope.New(builder.NewClusterBuilder(metav1.NamespaceDefault, "cluster1").Build())
			...
			gotControlPlaneObject := builder.NewControlPlaneBuilder("", "").Build()
...
func TestReconcileControlPlaneInfrastructureMachineTemplate(t *testing.T) {
	...
	// Create InfrastructureMachineTemplates for test cases
	infrastructureMachineTemplate := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infra1").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
	infrastructureMachineTemplate2 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infra2").
		WithSpecFields(map[string]interface{}{"spec.template.spec.fakeSetting": true}).
		Build()
	...
	controlPlaneWithInstanceSpecificChanges.SetLabels(map[string]string{"foo": "bar"})
	// ControlPlane object with the same name as controlPlane1 but a different InfrastructureMachineTemplate
	controlPlane3 := builder.NewControlPlaneBuilder(metav1.NamespaceDefault, "cp1").
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotInfrastructureMachineTemplate := builder.NewInfrastructureMachineTemplateBuilder("", "").Build()
...
func TestReconcileMachineDeployments(t *testing.T) {
	infrastructureMachineTemplate1 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-1").Build()
	bootstrapTemplate1 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-1").Build()
	md1 := newFakeMachineDeploymentTopologyState("md-1", infrastructureMachineTemplate1, bootstrapTemplate1)

	infrastructureMachineTemplate2 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-2").Build()
	bootstrapTemplate2 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-2").Build()
	...
	infrastructureMachineTemplate3 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-3").Build()
	bootstrapTemplate3 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-3").Build()
	...
	infrastructureMachineTemplate4 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-4").Build()
	bootstrapTemplate4 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-4").Build()
	...
	infrastructureMachineTemplate5 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-5").Build()
	bootstrapTemplate5 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-5").Build()
	...
	infrastructureMachineTemplate6 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-6").Build()
	bootstrapTemplate6 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-6").Build()
	...
	infrastructureMachineTemplate7 := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-7").Build()
	bootstrapTemplate7 := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-7").Build()
	md7 := newFakeMachineDeploymentTopologyState("md-7", infrastructureMachineTemplate7, bootstrapTemplate7)

	infrastructureMachineTemplate8Create := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-8-create").Build()
	bootstrapTemplate8Create := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-8-create").Build()
	...
	infrastructureMachineTemplate8Delete := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-8-delete").Build()
	bootstrapTemplate8Delete := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-8-delete").Build()
	...
	infrastructureMachineTemplate8Update := builder.NewInfrastructureMachineTemplateBuilder(metav1.NamespaceDefault, "infrastructure-machine-8-update").Build()
	bootstrapTemplate8Update := builder.NewBootstrapTemplateBuilder(metav1.NamespaceDefault, "bootstrap-config-8-update").Build()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			s := scope.New(builder.NewClusterBuilder(metav1.NamespaceDefault, "cluster-1").Build())
...
func newFakeMachineDeploymentTopologyState(name string, infrastructureMachineTemplate, bootstrapTemplate *unstructured.Unstructured) *scope.MachineDeploymentState {
	return &scope.MachineDeploymentState{
		Object: builder.NewMachineDeploymentBuilder(metav1.NamespaceDefault, name).
