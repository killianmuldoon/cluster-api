...
func autoConvert_v1alpha4_MachineList_To_v1beta1_MachineList(in *MachineList, out *v1beta1.MachineList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1beta1.Machine)(unsafe.Pointer(&in.Items))
	return nil
}
...
// Convert_v1alpha4_MachineStatus_To_v1beta1_MachineStatus is an autogenerated conversion function.
func Convert_v1alpha4_MachineStatus_To_v1beta1_MachineStatus(in *MachineStatus, out *v1beta1.MachineStatus, s conversion.Scope) error {
